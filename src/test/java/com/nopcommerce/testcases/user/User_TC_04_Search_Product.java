...
public class User_TC_04_Search_Product extends BaseTest {
    ...
    public void TC_04_Search_Product(){
        ...
        for (String productName : productNameList) {
            Assert.assertTrue(
                    productName.toLowerCase().contains(search.getSearch().toLowerCase()),
                    "Product name does not contain search keyword: " + productName
            );
        }
    }
